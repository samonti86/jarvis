...
discipline as scripts/homelab_alert_test.py and scripts/leak_repro.py: a
standalone asserting harness so a regression in the firing rule is caught
structurally.

    python scripts/calendar_monitor_test.py    # exit 0 = all pass, 1 = any failed
"""
...
# Allow `python scripts/calendar_monitor_test.py` from anywhere.
