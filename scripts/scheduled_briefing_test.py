...
Same instrument discipline as scripts/homelab_alert_test.py and
scripts/acoustic_alert_test.py — a regression here would silently break
"brief me every weekday at 7" without py_compile noticing.

    python scripts/scheduled_briefing_test.py     # exit 0 = pass
"""
import sys
