...
discipline as tests/calendar_monitor_test.py and tests/homelab_alert_test.py.

    python tests/presence_test.py    # exit 0 = all pass, 1 = any failed
"""
...
# Allow `python tests/presence_test.py` from anywhere.
